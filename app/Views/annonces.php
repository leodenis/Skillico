				            ...
				            <fieldset>
				            	<div id="part_connect">
			            			...
			            			<form action="user/connexion" method="post" enctype="multipart/form-data">
						                ...
						                <input id="sendRequest" type="submit" value="Connexion"/>
						            </form>
				...
				<ul class="menuOffre" style="background-color:white;">
					...
					<div id="cat_offer">
						<?php foreach($cat_list as $cat): ?>
							<input type="checkbox" id="check1" name="chk1" value="<?php echo $cat['id_offer_cat']?>"/><label class="rad" for="check1" ><?php echo $cat['title']?></label><br/>
						<?php endforeach; ?>
					</div>
